...
function App() {
  ...
  const isMemberMetafields = useAppMetafields({
    namespace: 'membership',
    key: 'isMember',
    type: 'customer',
  });
  const isMembersOnlyMetafields = useAppMetafields({
    namespace: 'membership',
    key: 'isMembersOnly',
    type: 'product',
  });
...
function LoadingSkeleton() {
  return (
    <BlockStack spacing='loose'>
      <Divider />
      <Heading level={2}>Purchase a membership</Heading>
      <BlockStack spacing='loose'>
        <InlineLayout
          spacing='base'
